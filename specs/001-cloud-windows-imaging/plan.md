...
The Imaging Core API owns storage permissions, SAS token issuance, session state,
...
- DeviceGatewayApi: Azure Functions v4, Flex Consumption plan (public HTTPS endpoint)
- OperatorApi: Azure Functions v4, Flex Consumption plan (public HTTPS endpoint, Entra ID secured)
...
- Boot image SAS tokens: configurable, shorter window than OS image tokens (e.g., 2 hours)
