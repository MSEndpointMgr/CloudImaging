...
namespace CloudImaging.MediaBuilder.Logging;

/// <summary>
/// Configures rolling file logging for the Cloud Imaging Media Builder WPF application.
/// Max 10 MB per file, 5 files retained, no network dependency (FR-066).
/// </summary>
internal static class LoggingConfiguration
{
    ...
    public static Serilog.Core.Logger CreateLogger()
    {
        string logDirectory = Path.Combine(
            ...
            "CloudImaging", "MediaBuilder", "Logs");
        ...
        return new LoggerConfiguration()
            ...
            .WriteTo.File(
                path:           Path.Combine(logDirectory, "cloud-imaging-mediabuilder-.log"),
